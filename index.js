...
async function executarAgente() {
    try {
        ...
        const prompt = "Explique  um conceito técnico (ex: O que é JavaScript, O que é uma API, O que é um Banco de Dados) Voce vai responder como se fosse um cientista maluco";
